    ...
    <div className="mb-10 space-y-4">
      ...
      <div className="grid sm:grid-cols-2 gap-4">
        <div className="glass rounded-2xl p-5">
          ...
          <div className="text-xs text-slate-500 bg-white/5 rounded-lg px-3 py-2">👻 Aave V3 · Ethereum</div>
        </div>
        <div className="glass rounded-2xl p-5 border border-green-500/20">
          ...
          <div className="text-xs text-green-400/70 bg-green-500/10 rounded-lg px-3 py-2">🏦 Compound V3 · Arbitrum</div>
        </div>
      </div>
      <div className="glass rounded-2xl p-5 border border-sky-500/20">
        <div className="flex items-center justify-between">
          <div>
            ...
            <div className="text-3xl font-bold text-green-400">+${annualGain.toFixed(0)}/year</div>
            <div className="text-xs text-slate-400 mt-1">
              +{(bestApy - currentApy).toFixed(2)}% APY via LayerZero V2
            </div>
          </div>
